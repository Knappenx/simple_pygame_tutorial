...
background = pygame.image.load('Game/ds_bg.jpg')
...
class Player(object):
    ...
    def hit(self):
        ...
        self.y = 410
        self.walk_count = 0
        font_damage = pygame.font.SysFont('ubuntumono', 50, True)
        text_damage = font_damage.render('YOU DIED', 1, (255,0,0))
...
def redraw_game_window():
    ...
    text = font.render(f"Score: {score}", 1, (255,255,0))
